...
public class Servidor {
    ...
    public void abreServidor() throws IOException{
        ...
        while(true){
            ...
            System.out.println("Conexão com o cliente " + cliente.getInetAddress()
            .getHostAddress() + " estabilizada com sucesso!");
    ...
    public void distribuiMensagens(String mensagem){
        ...
        //Distribui a mensagem enviada à este método para todos os clientes.
